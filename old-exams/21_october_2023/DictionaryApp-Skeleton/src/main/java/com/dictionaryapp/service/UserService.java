...
import com.dictionaryapp.dto.RegistrationDTO;
...
public class UserService {
    ...
    public UserService(UserRepo userRepo, LoggedUser loggedUser, PasswordEncoder passwordEncoder, HttpSession httpSession) {
    ...
    public void saveUser(User admin1) {
        this.userRepo.save(admin1);
    }

    public void register(RegistrationDTO registrationDTO) {
        this.userRepo.save(this.mapUser(registrationDTO));
        this.login(registrationDTO.getUsername());
    }
